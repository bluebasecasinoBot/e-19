...
__SYD.footer_main_parent = () =>{
    ...
    return __c(
        'div',
        {
            style:`height:fit-content;padding:${check ? "20px 50px" : "20px 10px"};padding-top:50px;padding-bottom:20px;background:${"#000000"};width:100%;display:flex;flex-direction:column;row-gap:40px;padding-bottom:50px;`,
            id:"footer"
        },
        [
            // __c(
            ...
            __c(
                ...
                [
                    __c(
                        ...
                        [
                            __c("p" , {style:"color:#fff;font-weight:900;width:100%;max-width:unset;text-align:center;"},[
                    ...
                    __SYD.text_lib_type_p_glob_vmax({cnt:`© ${new Date().getFullYear()} All Right Reserved`,size:'12px',clr:'#fff' , inject:"font-weight:900;"})
                ]
            )
        ],
        {
            type:"footer_main_parent"
        }
    )
}
